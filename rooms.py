...
rooms = {
    "room1": {
        ...
        "decor": [
            ...
            {"type": "tree1", "x": 120, "y": 380},
            {"type": "tree2", "x": 200, "y": 360},
            {"type": "tree3", "x": 360, "y": 390},
            {"type": "tree1", "x": 520, "y": 320},
            {"type": "tree2", "x": 700, "y": 350},
            {"type": "tree3", "x": 820, "y": 380},
            {"type": "tree1", "x": 980, "y": 360},
        ...
        "obstacles": [
            ...
            pygame.Rect(120, 380, 64, 64),
            pygame.Rect(200, 360, 64, 64),
            pygame.Rect(360, 390, 64, 64),
            pygame.Rect(520, 320, 64, 64),
            pygame.Rect(700, 350, 64, 64),
            pygame.Rect(820, 380, 64, 64),
            pygame.Rect(980, 360, 64, 64),
        ],
        "npcs": [
    ...
    "room2": {
        ...
        "decor": [
            ...
            {"type": "tree2", "x": 220, "y": 360},
            {"type": "tree1", "x": 420, "y": 340},
            {"type": "tree3", "x": 620, "y": 340},
            {"type": "tree2", "x": 760, "y": 360},
    ...
    "room4": {
        ...
        "background_image": "assets/backgrounds/background4.png",
        "decor": [
            {"type": "tree2", "x": 180, "y": 360},
            {"type": "tree1", "x": 360, "y": 370},
            {"type": "tree3", "x": 520, "y": 380},
            {"type": "tree2", "x": 760, "y": 350},
            {"type": "tree1", "x": 960, "y": 370},
        ],
        "npcs": [],
    },
}
